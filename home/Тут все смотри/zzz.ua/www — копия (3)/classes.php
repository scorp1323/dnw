...
class NewsPublication extends Publication {
	public function printItem() {
		echo '<br><font size="3"><em><b>Новость:</em></b></font> ' . '<font color="#191970" size="4">' . '<b>' . $this -> title . '</b>' .'</font>' ;		
...
class ArticlePublication extends Publication {
	public function printItem() {
		echo '<br><font size="3"><em><b>Заголовок:</em></b></font> ' . '<font color="#191970" size="4">' . '<b>' . $this -> title . '</b>' .'</font>';
